  ...
  const features = [
    {
      ...
      desc: 'Com a metodologia mobile first, seu site será responsivo para todos os dispositivos.',
      link: '/'
    },
    {
      id: 2,
      ...
      desc: 'Com metodos de otimização de imagens e de código, seu site será rápido e eficiente.',
      link: '/'
    },
    {
      id: 3,
      ...
      title: 'SEO',
      alt: 'Imagem de uma webpage',
      desc: 'Melhores práticas de SEO para que seu site seja encontrado no Google.',
      link: '/'
    }
  ]
  return (
